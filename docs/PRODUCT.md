...
Codebase Inspection is a focused, shareable agent workflow.

## What it does

Measure a codebase’s size, languages, and composition without changing it. Use when a user asks for this workflow or a closely related task.
